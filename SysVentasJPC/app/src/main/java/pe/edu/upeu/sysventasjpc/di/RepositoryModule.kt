...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun productoRepository(prodRepos:
                                    ProductoRepositoryImp): ProductoRepository
    @Binds
    @Singleton
    ...
    @Binds
    @Singleton
    abstract fun categoriaRepository(categoriaRepos:
                                     CategoriaRepositoryImp): CategoriaRepository
    @Binds
    @Singleton
    abstract fun unidadMedRepository(unidmedRepos:
                                     UnidadMedidaRepositoryImp): UnidadMedidaRepository
}
